...
@ex.config
def config():
    data_folder = '/home/root/KITTI/dataset_color/'
    test_sequence = '00'
    ...
    out_fig_lg = 'EN' # [EN, CN]
weights = [ '/home/root/work_station_02/checkpoints_f/checkpoint_r5.00_t0.50.tar', '/home/root/work_station_02/checkpoints_f/checkpoint_r2.00_t0.20.tar', '/home/root/work_station_02/checkpoints_f/checkpoint_r1.00_t0.10.tar']
...
def main(_config, seed):
    ...
    inference_time = (total_time / len(TestImgLoader)) * 1000.0  # 毫秒 处理一个batch的时间。
